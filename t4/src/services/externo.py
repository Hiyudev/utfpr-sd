...
def pay_transaction(transaction_id: str):
    ...
    reference: dict[str, any] = next((d for d in global_active_transactions if d['id'] == transaction_id), None)
    ...
    try:
        ...
        print("[MS-Externo] Um pagamento foi realizado.")
        
        return "Webhook sent successfully!", 200
    except requests.exceptions.RequestException as e:
        return f"Error sending webhook: {e}", 500
